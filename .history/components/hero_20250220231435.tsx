    ...
    useEffect(() => {
        const handleScroll = () => {
            ...
            if (benefitRef.current) {
                ...
                const translateX = -1110 + 1110 * progress;
        ...
        <>
            ...
            <div className="max-w-full md:max-w-[85rem] mx-auto md:absolute top-[100vh]">
                <div className="grid grid-cols-1 md:grid-cols-3 xl:grid-cols-7">
                    ...
                    <div ref={benefitRef} className="bg-sky-400 dark:bg-sky-800 transition transform duration-300 ease-in-out translate-x-[-1500px] p-6 xl:col-span-2">
