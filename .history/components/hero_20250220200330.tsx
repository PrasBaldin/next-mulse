                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div class="bg-white p-6 rounded-lg shadow-md">
                        <div class="text-center mb-4">
                            <svg class="w-12 h-12 mx-auto text-blue-500" fill="currentColor" viewBox="0 0 20 20">
                                <!-- SVG icon code here -->
                            </svg>
                        </div>
                        <h2 class="text-xl font-semibold text-center text-gray-800">100% Confidential</h2>
                        <p class="text-center text-gray-600 mt-2">Your data is secure with us.</p>
                    </div>
                    ...
                    <div class="bg-white p-6 rounded-lg shadow-md">
                        ...
                        <h2 class="text-xl font-semibold text-center text-gray-800">Qualified Team</h2>
                        <p class="text-center text-gray-600 mt-2">Professional and experienced staff.</p>
                    </div>
                    ...
                    <div class="bg-white p-6 rounded-lg shadow-md">
                        ...
                        <h2 class="text-xl font-semibold text-center text-gray-800">Individual Approach</h2>
                        <p class="text-center text-gray-600 mt-2">Personalized services tailored for you.</p>
                    </div>
                </div>
            </div>
        </>
