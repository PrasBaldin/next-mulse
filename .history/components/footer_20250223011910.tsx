                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div>
                        ...
                        <nav className="flex flex-col space-y-2">
                            <Link href="#">
                                <a className="hover:text-sky-400 transition-colors duration-300">Beranda</a>
                            </Link>
                            <Link href="#">
                                <a className="hover:text-sky-400 transition-colors duration-300">Katalog</a>
                            </Link>
                            <Link href="#">
                                <a className="hover:text-sky-400 transition-colors duration-300">Galeri</a>
                            </Link>
                            <Link href="#">
                                <a className="hover:text-sky-400 transition-colors duration-300">Tentang Kami</a>
                            </Link>
                            <Link href="#">
                                <a className="hover:text-sky-400 transition-colors duration-300">Kontak</a>
                            </Link>
                        </nav>
                    </div>
                    ...
                    <div>
                        ...
                        <nav className="flex flex-col space-y-2">
                            <Link href="#">
                                <a className="hover:text-sky-400 transition-colors duration-300">Jasa Kontruksi</a>
                            </Link>
                            <Link href="#">
                                <a className="hover:text-sky-400 transition-colors duration-300">Pengadaan Barang</a>
                            </Link>
                        </nav>
                    </div>
