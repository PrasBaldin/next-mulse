            ...
            <div className="container grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div>
                    ...
                    <nav className="flex flex-col mt-2 space-y-2">
                        <Link href="#" className="hover:underline hover:text-sky-500 transition duration-500 ease-in-out">Beranda</Link>
                        <Link href="#" className="hover:underline hover:text-sky-500 transition duration-500 ease-in-out">Katalog</Link>
                        <Link href="#" className="hover:underline hover:text-sky-500 transition duration-500 ease-in-out">Galeri</Link>
                        <Link href="#" className="hover:underline hover:text-sky-500 transition duration-500 ease-in-out">Tentang Kami</Link>
                        <Link href="#" className="hover:underline hover:text-sky-500 transition duration-500 ease-in-out">Kontak</Link>
                    </nav>
                </div>
                ...
                <div>
                    ...
                    <nav className="flex flex-col mt-2 space-y-2">
                        <Link href="#" className="hover:underline hover:text-sky-500 transition duration-500 ease-in-out">Jasa Kontruksi</Link>
                        <Link href="#" className="hover:underline hover:text-sky-500 transition duration-500 ease-in-out">Pengadaan Barang</Link>
                    </nav>
                </div>
