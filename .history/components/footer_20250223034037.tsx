                    ...
                    <div>
                        ...
                        <div className="flex mt-4 space-x-4">
                            <a href="#" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="hover:text-sky-400 transition-colors duration-300" >
                                <svg className="w-5 h-5 rounded" fill="currentColor" viewBox="0 0 24 24" stroke="none">
                            ...
                            <a href="#" target="_blank" rel="noopener noreferrer" aria-label="Tiktok" className="hover:text-sky-400 transition-colors duration-300" >
