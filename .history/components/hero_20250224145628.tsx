            ...
            <div className="py-5">
              ...
              <div className="pt-5">
                <a
                  ...
                  target="_blank"
                >
                  <button className="btn btn-primary bg-sky-600 hover:bg-sky-700 dark:hover:bg-sky-700 text-gray-100 font-medium">
                    E-Katalog
                  </button>
                </a>
                <Link href="/about">
                  <button className="btn btn-secondary ml-3 font-medium">
                    More About Us
                  </button>
                </Link>
              </div>
