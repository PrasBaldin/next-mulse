                ...
                <div className="container">
                    <div className="flex justify-between items-center">
                        <div className="w-full">
                            <a href="/" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="social-media-link hover:text-sky-400 transition-colors duration-300 max-w-[20px]" >
                            ...
                            <a href="/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="social-media-link hover:text-sky-400 transition-colors duration-300 max-w-[20px]" >
                            ...
                            <a href="/" target="_blank" rel="noopener noreferrer" aria-label="Tiktok" className="social-media-link hover:text-sky-400 transition-colors duration-300 max-w-[20px]" >
