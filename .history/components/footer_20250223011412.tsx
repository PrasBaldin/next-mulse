                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div>
                        ...
                        <div className="flex mt-4 space-x-4">
                            <a href="#" target="blank" aria-label="Facebook" className="hover:text-blue-500 transition-colors duration-300">
                            ...
                            <a href="#" target="blank" aria-label="Instagram" className="hover:text-blue-400 transition-colors duration-300">
                                icon instagram svg
                            </a>
                            <a href="#" target="blank" aria-label="Tiktok" className="hover:text-blue-700 transition-colors duration-300">
                                icon tiktok svg
                            </a>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-sm">
                            ...
                            <li className="flex items-center">
                                <svg className="w-4 h-4 mr-2" fill="currentColor" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 30.667 30.667" xmlSpace="preserve">
                                    <g>
