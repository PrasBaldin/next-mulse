                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center">
                            ...
                            <span className="ml-4 font-bold text-xl bg-gradient-to-r from-sky-400 to-indigo-500 bg-clip-text text-transparent">
                                PT. MULSE CITRA NUSA
                            </span>
                        </div>
                        <p className="text-sm">
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-sm">
                            ...
                            <li className="flex items-center">
                                <svg className="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 30.667 30.667">
                                    <g>
                    ...
                    <div>
                        ...
                        <div className="flex flex-col space-y-2">
                            <Link href="#">
                                <a className="hover:text-sky-400 transition-transform duration-300 hover:scale-105">Beranda</a>
                            </Link>
                            <Link href="#">
                                <a className="hover:text-sky-400 transition-transform duration-300 hover:scale-105">Katalog</a>
                            </Link>
                            <Link href="#">
                                <a className="hover:text-sky-400 transition-transform duration-300 hover:scale-105">Galeri</a>
                            </Link>
                            <Link href="#">
                                <a className="hover:text-sky-400 transition-transform duration-300 hover:scale-105">Tentang Kami</a>
                            </Link>
                            <Link href="#">
                                <a className="hover:text-sky-400 transition-transform duration-300 hover:scale-105">Kontak</a>
                            </Link>
                        </div>
                    </div>
                    ...
                    <div>
                        <div>
                            ...
                            <div className="flex flex-col space-y-2">
                                <Link href="#">
                                    <a className="hover:text-sky-400 transition-transform duration-300 hover:scale-105">Jasa Kontruksi</a>
                                </Link>
                                <Link href="#">
                                    <a className="hover:text-sky-400 transition-transform duration-300 hover:scale-105">Pengadaan Barang</a>
                                </Link>
                            </div>
                        </div>
