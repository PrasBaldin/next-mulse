            ...
            <div className="max-w-full md:max-w-7xl mx-auto md:absolute top-[100vh]">
                <div className="grid grid-cols-1 md:grid-cols-3 xl:grid-cols-4">
                    ...
                    <div className="bg-sky-200 dark:bg-sky-600 transition duration-700 ease-in-out p-6">
                        ...
                        <p className="text-center text-gray-600 mt-2">Jika Anda merasa tidak puas, kami siap memberikan solusi atau pengembalian dana sesuai ketentuan yang berlaku.</p>
                    </div>
                </div>
            </div>
        </>
