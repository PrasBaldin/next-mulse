                ...
                <div className="container">
                    <div className="p-3 w-full lg:w-[55vw] absolute top-[35vh] max-lg:left-0 max-lg:right-0 text-gray-100 transition duration-300 ease-in-out">
                        <div className="py-5">
                            ...
                            <h1
                                className={`text-4xl lg:text-5xl xl:text-6xl font-bold pb-5 transition-opacity duration-500 ${animate ? "opacity-0" : "opacity-100"
                                    }`}
                            >
                                {slideContent[currentIndex].title}
                            </h1>
                            <p
                                className={`md:text-xl font-medium transition-opacity duration-500 ${animate ? "opacity-0" : "opacity-100"
                                    }`}
                            >
