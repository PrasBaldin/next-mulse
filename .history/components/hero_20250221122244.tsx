        ...
        <>
            <div className="hero-wrap relative">
                ...
                <div className="container">
                    ...
                    <div className="absolute top-[50vh] right-5 flex flex-col">
                        {images.map((_, index) => (
                            <button
                                key={index}
                                onClick={() => handleNavigation(index)}
                                className={`w-3 h-3 rounded-full transition duration-500 ease-in-out my-2 ${index === currentIndex ? "bg-sky-500" : "bg-gray-300"
                                    }`}
                            />
                        ))}
                    </div>
