                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-sm">
                            ...
                            <li className="flex items-center">
                                ...
                                <a className="hover:text-sky-400 transition duration-300" href="mail:info@mulse.id" target="_blank">
                                    info@mulse.id
                                </a>
                            </li>
                            <li className="flex items-center">
                      ...
                      C23.307,19.268,23.307,18.533,23.214,18.38z"/>
                            ...
                            <li className="flex items-center">
                                ...
                                <a className="hover:text-sky-400 transition duration-300" href="tel:02122049859" target="_blank">021 2204 9859</a>
                            </li>
                        </ul>
                    </div>
