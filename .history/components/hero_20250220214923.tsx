        ...
        <>
            <div className="hero-wrap">
                ...
                <div className="container">
                    ...
                    <div className="p-3 w-full lg:w-[60vw] absolute top-[40vh] max-lg:left-0 max-lg:right-0 text-gray-900 dark:text-gray-100 transition duration-300 ease-in-out">
                        <div className=" py-5">
                            ...
                            <div className="pt-3">
                                <button className="btn bg-sky-500 hover:bg-sky-700 text-gray-100 text-semibold">E-Katalog</button>
                                <button className="btn ml-3 bg-gray-100 hover:bg-gray-400 text-gray-700 text-semibold">More About Us</button>
                            </div>
                        </div>
                    </div>
                </div>
