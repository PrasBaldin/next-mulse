            ...
            <div className="max-w-full md:max-w-7xl mx-auto md:absolute top-[100vh]">
                <div className="grid grid-cols-1 md:grid-cols-3 xl:grid-cols-4">
                    ...
                    <div className="bg-sky-400 dark:bg-sky-800 transition duration-300 ease-in-out p-6">
                        ...
                        <p className="text-center text-gray-600 mt-2">Kami menjamin kualitas terbaik untuk setiap produk dan layanan yang kami tawarkan. Dengan melalui serangkaian proses kontrol kualitas yang ketat, kami memastikan setiap detail diperhatikan demi kepuasan Anda.</p>
                    </div>
