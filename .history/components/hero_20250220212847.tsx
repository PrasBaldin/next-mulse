        ...
        <>
            <div className="hero-wrap">
                ...
                <div className="container">
                    <div className="w-full lg:w-[60vw] absolute top-[40vh] max-lg:left-0 max-lg:right-0 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-100 transition duration-300 ease-in-out">
                        <div className="p-5">
                            ...
                            <div className="pt-3">
                                ...
                                <button className="btn ml-3 bg-gray-100 hover:bg-gray-300 text-gray-700">More About Us</button>
                            </div>
                        </div>
                    </div>
                </div>
