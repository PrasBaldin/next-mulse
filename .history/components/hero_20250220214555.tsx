        ...
        <>
            <div className="hero-wrap">
                <div className="flex justify-center items-center">
                    <div ref={parallaxRef} className="relative h-[110vh] w-full bg-cover bg-center bg-fixed translate-y-[-0.2px]" style={{ backgroundImage: `url('/img/parallax.jpg')` }} >
                        <div className="hero-mask" />
                    </div>
                </div>
                <div className="container">
                    {/* bg-gray-100 dark:bg-gray-700 */}
                    <div className=" bg-opacity-40 backdrop-blur-md p-3 w-full lg:w-[60vw] absolute top-[40vh] max-lg:left-0 max-lg:right-0 text-gray-900 dark:text-gray-100 transition duration-300 ease-in-out">
                        <div className="p-5">
