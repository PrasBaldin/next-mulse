                ...
                <div className="container">
                    <div className="p-3 w-full lg:w-[60vw] absolute top-[40vh] max-lg:left-0 max-lg:right-0 text-gray-100 transition duration-300 ease-in-out">
                        <div className=" py-5">
                            ...
                            <p className="text-md font-medium">Solusi konstruksi berkualitas yang memenuhi standar industri terbaik. Didukung tim profesional berpengalaman, kami menangani setiap proyek dengan ketelitian dan keahlian, mulai dari perencanaan hingga pelaksanaan. Dengan komitmen terhadap kualitas, kami menciptakan bangunan yang kokoh, fungsional, dan estetis untuk kepuasan maksimal.</p>
                            <div className="pt-3">
