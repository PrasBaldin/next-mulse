...
const Navbar = () => {
  ...
  return (
    <>
      ...
      {/* Sidebar Menu */}
      <div
        className={`bg-white dark:bg-gray-800 lg:hidden fixed mt-[72px] right-0 w-64 h-full shadow-lg transform transition-transform duration-500 ease-in-out z-10 ${
