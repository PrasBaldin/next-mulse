        ...
        <>
            ...
            <div className="max-w-full md:max-w-7xl mx-auto md:absolute top-[100vh]">
                <div className="grid grid-cols-1 md:grid-cols-3 xl:grid-cols-4">
                    <div className="bg-sky-500 p-6 shadow-md hidden xl:block" />
                    <div className="bg-sky-500 p-6 shadow-md">
                    ...
                    <div className="bg-sky-600 p-6 shadow-md">
                        <div className="text-center mb-4">
                    ...
                    <div className="bg-sky-700 p-6 shadow-md">
                        <div className="text-center mb-4">
