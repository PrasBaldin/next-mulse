        ...
        <>
            <div className="hero-wrap">
                <div className="flex justify-center items-center">
                    <div ref={parallaxRef} className="relative h-[180vh] w-full bg-cover bg-center bg-fixed translate-y-[-0.2px]" style={{ backgroundImage: `url('/img/parallax.jpg')` }} >
                        <div className="hero-mask" />
                    </div>
                </div>
                <div className="container">
                    {/* bg-gray-100 dark:bg-gray-700 */}
                    <div className=" bg-opacity-40 backdrop-blur-xs p-3 w-full lg:w-[60vw] absolute top-[40vh] max-lg:left-0 max-lg:right-0 text-gray-900 dark:text-gray-100 transition duration-300 ease-in-out">
                        <div className="p-5">
                            <h3 className="text-xl">PT. Mulse Citra Nusa</h3>
                            <h1 className="text-4xl font-bold py-3">Jasa Kontruksi dan Pengadaan Barang</h1>
                            <p className="text-semibold">Solusi konstruksi berkualitas yang memenuhi standar industri terbaik. Didukung tim profesional berpengalaman, kami menangani setiap proyek dengan ketelitian dan keahlian, mulai dari perencanaan hingga pelaksanaan.</p>
                            <div className="pt-3">
                                <button className="btn bg-sky-500 hover:bg-sky-700 text-gray-100">E-Katalog</button>
                                <button className="btn ml-3 bg-gray-100 hover:bg-gray-400 text-gray-700">More About Us</button>
                            </div>
                        </div>
                    </div>
                </div>
