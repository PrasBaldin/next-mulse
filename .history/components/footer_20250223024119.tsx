                    ...
                    <div>
                        ...
                        <table className="space-y-3 text-sm">
                            <tbody>
                                <tr>
                                    <td className="py-2">
                                        <svg className="w-6 h-6 mr-2 hover:text-sky-400 transition duration-300" viewBox="0 0 192 192" xmlns="http://www.w3.org/2000/svg" fill="none">
                                    ...
                                    <td>
                                        <a className="hover:text-sky-400 transition duration-300" href="https://goo.gl/maps/oJyAZpEak73gKhBG8" target="_blank">
                                ...
                                <tr>
                                    <td className="py-2">
                                        <svg className="w-5 h-5 mr-2 hover:text-sky-400 transition duration-300" fill="currentColor" viewBox="0 0 24 24">
                                ...
                                <tr>
                                    <td className="py-2">
                                        <svg className="w-5 h-5 mr-2 hover:text-sky-400 transition duration-300" fill="currentColor" viewBox="0 0 30.667 30.667">
                                            <g>
                      ...
                      C23.307,19.268,23.307,18.533,23.214,18.38z"/>
                                    ...
                                    <td>
                                        <a className="hover:text-sky-400 transition duration-300" href="https://api.whatsapp.com/send?phone=6285260062002&text=Hallo%20Mulse!%20saya%20membutuhkan%20bantuan%20terkait%20layanan%20di%20mulse.id" target="_blank">
                                            +62 852 6006 2002
                                        </a>
                                    </td>
                                </tr>
                                <tr>
                                    <a className="hover:text-sky-400 transition duration-300" href="tel:+622122049859" target="_blank">
                                        <td className="py-2">
                                            <svg className="w-5 h-5 mr-2 hover:text-sky-400 transition duration-300" fill="currentColor" viewBox="0 0 24 24">
