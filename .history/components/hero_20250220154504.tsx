    ...
    return (
        <div className="hero h-[110vh] overflow-hidden">
            ...
            <div className="container">
                <div className="w-full lg:w-[50vw] absolute top-[40vh] bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-100 transition duration-300 ease-in-out">
                    <div className="">
                        <h3>PT. Mulse Citra Nusa</h3>
                        <h1 className="text-3xl">Jasa Kontruksi dan Pengadaan Barang</h1>
                    </div>
                </div>
            </div>
        </div>
