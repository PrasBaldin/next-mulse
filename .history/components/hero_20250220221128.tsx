            ...
            <div className="hero-wrap min-h-[40rem]">
                ...
                <div className="container">
                    <div className="p-3 w-full lg:w-[55vw] absolute top-[40vh] max-lg:left-0 max-lg:right-0 text-gray-100 transition duration-300 ease-in-out">
                        <div className=" py-5">
                            <h3 className="text-2xl font-semibold">PT. Mulse Citra Nusa</h3>
                            <h1 className="text-4xl md:text-7xl font-bold py-3">Jasa Kontruksi dan Pengadaan Barang</h1>
                            <p className="text-xl font-medium">Solusi konstruksi berkualitas yang memenuhi standar industri terbaik dan didukung oleh tim profesional berpengalaman yang menangani setiap proyek dengan ketelitian serta keahlian. Dengan komitmen terhadap kualitas, kami menciptakan bangunan yang kokoh, fungsional, dan estetis untuk kepuasan maksimal.</p>
                            <div className="pt-3">
