                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-sm table">
                            <li className="table-row">
                                ...
                                <div className="table-cell">
                                    <div className="flex items-center h-full">
                                        <a className="hover:text-sky-400 transition duration-300" href="https://goo.gl/maps/oJyAZpEak73gKhBG8" target="_blank">Jl. SMA 14 B, Kel. Cililitan, Kec. Keramat Jati, Jakarta Timur</a>
                                    </div>
                                </div>
                            </li>
                            <li className="table-row">
                      ...
                      C23.307,19.268,23.307,18.533,23.214,18.38z"/>
                            ...
                            <li className="table-row">
                                <div className="table-cell">
                                    <div className="flex items-center h-full">
                                        <svg className="w-5 h-5 mr-2 mt-auto" fill="currentColor" viewBox="0 0 24 24">
