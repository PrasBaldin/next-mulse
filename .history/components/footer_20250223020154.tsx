                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-sm">
                            <li className="flex items-center">
                                ...
                                <a className="hover:text-sky-500 transition" href="https://goo.gl/maps/oJyAZpEak73gKhBG8" target="_blank">Jl. SMA 14 B, Cililitan, Keramat Jati, Jakarta Timur</a>
                            </li>
                            <li className="flex items-center">
                                <svg className="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 24 24">
                                    <path d="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z" />
                                </svg>
                                <a className="hover:text-sky-500 transition" href="mail:info@mulse.id" target="_blank">
                                    info@mulse.id
                                </a>
                            </li>
                            <li className="flex items-center">
                      ...
                      C23.307,19.268,23.307,18.533,23.214,18.38z"/>
                                ...
                                <a className="hover:text-sky-500 transition" href="https://api.whatsapp.com/send?phone=6285260062002&text=Hallo%20Mulse!%20saya%20membutuhkan%20bantuan%20terkait%20layanan%20di%20mulse.id" target="_blank">+62 852 6006 2002</a>
                            </li>
                            <li className="flex items-center">
                                <svg className="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 24 24">
                                ...
                                <a className="hover:text-sky-500 transition" href="tel:02122049859" target="_blank">021 2204 9859</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="flex flex-col space-y-2">
                            <Link className="hover:text-sky-400 transition-colors duration-300" href="#">
                                Beranda
                            </Link>
                            <Link className="hover:text-sky-400 transition-colors duration-300" href="#">
                                Katalog
