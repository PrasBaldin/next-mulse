...
export default function Hero() {
    ...
    return (
        <>
            ...
            <div className="max-w-full md:max-w-7xl mx-auto absolute top-[100vh]">
                <div className="grid grid-cols-1 md:grid-cols-3 xl:grid-cols-4">
                    <div className="bg-sky-500 p-6 rounded-lg shadow-md hidden xl:block" />
                    <div className="bg-sky-500 p-6 rounded-lg shadow-md">
                        <div className="text-center mb-4">
                            <svg className="w-12 h-12 mx-auto text-blue-500" fill="currentColor">
                                <span>test</span>
                            </svg>
                        </div>
                    ...
                    <div className="bg-sky-600 p-6 rounded-lg shadow-md">
                        <div className="text-center mb-4">
                            <svg className="w-12 h-12 mx-auto text-green-500" fill="currentColor">
                                <span>test</span>
                            </svg>
                        </div>
                    ...
                    <div className="bg-sky-700 p-6 rounded-lg shadow-md">
                        <div className="text-center mb-4">
                            <svg className="w-12 h-12 mx-auto text-red-500" fill="currentColor">
                                <span>test</span>
                            </svg>
                        </div>
