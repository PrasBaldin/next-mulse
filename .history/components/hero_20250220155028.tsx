    ...
    return (
        <div className="hero h-[110vh] overflow-hidden">
            ...
            <div className="container">
                <div className="w-full lg:w-[65vw] absolute top-[35vh] left-0 right-0 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-100 transition duration-300 ease-in-out">
                    <div className="p-5">
