        ...
        <>
            ...
            <div className="max-w-full md:max-w-[85rem] mx-auto md:absolute top-[100vh]">
                <div className="grid grid-cols-1 md:grid-cols-3 xl:grid-cols-7">
                    ...
                    <div ref={benefitRef} className="bg-sky-400 dark:bg-sky-800 transition transform duration-300 ease-in-out translate-x-[-500px] p-6 xl:col-span-2 z-[4]">
                    ...
                    <div ref={benefitRef} className="bg-sky-300 dark:bg-sky-700 transition duration-500 ease-in-out translate-x-[-500px] p-6 xl:col-span-2 z-[3]">
                        <div className="flex items-center">
                    ...
                    <div ref={benefitRef} className="bg-sky-200 dark:bg-sky-600 transition duration-700 ease-in-out translate-x-[-500px] p-6 xl:col-span-2 z-[2]">
                        <div className="flex items-center">
                            <div className="mb-4 px-[2rem]">
                                <IconThumbUp />
                            </div>
