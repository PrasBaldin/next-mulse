...
const Navbar = () => {
    ...
    return (
        <>
            ...
            <nav className="navbar lg:top-[40px]">
                <div className="container">
                    <div className="flex justify-between items-center">
            ...
            {/* Sidebar Menu */}
            < div className={`bg-white dark:bg-gray-800 lg:hidden fixed top-16 right-0 w-64 h-full shadow-lg transform transition-transform duration-300 z-9 ${isOpen ? "translate-x-0" : "translate-x-full"}`}  >
