        ...
        <>
            ...
            <div className="max-w-full md:max-w-7xl mx-auto md:absolute top-[100vh]">
                <div className="grid grid-cols-1 md:grid-cols-3 xl:grid-cols-4">
                    <div className="dark:bg-sky-800 transition duration-300 ease-in-out p-6 hidden xl:block" />
                    <div className="dark:bg-sky-800 transition duration-300 ease-in-out p-6">
                    ...
                    <div className="dark:bg-sky-700 transition duration-500 ease-in-out p-6">
                        <div className="text-center mb-4">
                    ...
                    <div className="dark:bg-sky-600 transition duration-700 ease-in-out p-6">
                        <div className="text-center mb-4">
