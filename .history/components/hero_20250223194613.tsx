            ...
            <div className="py-5">
              ...
              <div className="pt-5">
                <a
                  ...
                  target="_blank"
                  className="bg-sky-600 hover:bg-sky-700 dark:hover:bg-sky-700 text-gray-100 font-medium"
                >
                  <button className="btn ">E-Katalog</button>
                </a>
                <Link
                  href="/about"
                  className="btn ml-3 bg-gray-100 hover:bg-gray-400 dark:hover:bg-gray-400 text-gray-700 font-medium"
                >
                  More About Us
                </Link>
              </div>
