        ...
        <>
            <div className="hero-wrap">
                ...
                <div className="container">
                    ...
                    <div className="bg-white bg-opacity-40 backdrop-blur-md p-3 w-full lg:w-[60vw] absolute top-[40vh] max-lg:left-0 max-lg:right-0 text-gray-700 dark:text-gray-100 transition duration-300 ease-in-out">
                        <div className="p-5">
                            <h3 className="text-xl">PT. Mulse Citra Nusa</h3>
                            <h1 className="text-4xl font-bold py-3">Jasa Kontruksi dan Pengadaan Barang</h1>
                            <p>Solusi konstruksi berkualitas yang memenuhi standar industri terbaik. Didukung tim profesional berpengalaman, kami menangani setiap proyek dengan ketelitian dan keahlian, mulai dari perencanaan hingga pelaksanaan.</p>
                            <div className="pt-3">
