                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-sm table">
                            <li className="flex items-center table-row">
                                <div className="w-[10%]">
                      ...
                      C23.307,19.268,23.307,18.533,23.214,18.38z"/>
                            ...
                            <li className="flex items-center table-row">
                                ...
                                <div className="w-[80%]">
                                    <a className="hover:text-sky-400 transition duration-300 w-full" href="tel:+622122049859" target="_blank">021 2204 9859</a>
                                </div>
                            </li>
                        </ul>
                    </div>
