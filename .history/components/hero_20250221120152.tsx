                    ...
                    <div className="p-3 w-full md:w-[60vw] lg:w-[50vw] xl:w-[45vw] absolute top-[35vh] max-lg:left-0 max-lg:right-0 text-gray-100 transition duration-300 ease-in-out">
                        <div className="py-5">
                            ...
                            <h1 className="text-4xl lg:text-5xl xl:text-6xl font-bold pb-5">
                                {/* Tambahkan key agar komponen Typewriter di-remount setiap kali teks berubah */}
                                <Typewriter
                                    key={slideContent[currentIndex].title}
                                    text={slideContent[currentIndex].title}
                                    speed={50} // gunakan nilai lebih kecil untuk pengetikan lebih cepat
                                />
                            </h1>
                            <p className="md:text-xl font-medium">
                                <Typewriter
                                    key={slideContent[currentIndex].description}
                                    text={slideContent[currentIndex].description}
                                    speed={30} // gunakan nilai lebih kecil untuk pengetikan lebih cepat
                                />
                            </p>
                            <div className="pt-5">
