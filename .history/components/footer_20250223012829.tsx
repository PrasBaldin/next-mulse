                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div>
                        <div className="flex items-center">
                            <Image src={MulseSvg} alt="Mulse Logo" className="w-16 mb-4" />
                            <span className="ml-4 font-bold">PT. MULSE CITRA NUSA</span>
                        </div>
                        <p className="text-sm">
                            Sebuah perusahaan yang bergerak di bidang teknologi dan inovasi, menyediakan solusi digital terbaik untuk kebutuhan bisnis Anda.
                        </p>
