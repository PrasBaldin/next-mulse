    ...
    useEffect(() => {
        const handleScroll = () => {
            ...
            if (benefit.current) {
                ...
                const translateX = -10 + 10 * progress;
                benefit.current.style.transform = `translateX(${translateX}px)`;
            }
        };
        ...
        <>
            ...
            <div className="max-w-full md:max-w-[85rem] mx-auto md:absolute top-[100vh]">
                <div className="grid grid-cols-1 md:grid-cols-3 xl:grid-cols-7">
                    ...
                    <div ref={benefit} className="bg-sky-400 dark:bg-sky-800 transition duration-300 ease-in-out p-6 xl:col-span-2">
