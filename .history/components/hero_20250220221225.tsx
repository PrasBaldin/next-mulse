        ...
        <>
            <div className="hero-wrap min-h-[40rem]">
                ...
                <div className="container">
                    <div className="p-3 w-full lg:w-[55vw] absolute top-[25vh] max-lg:left-0 max-lg:right-0 text-gray-100 transition duration-300 ease-in-out">
                        <div className=" py-5">
                            <h3 className="text-2xl font-semibold">PT. Mulse Citra Nusa</h3>
                            <h1 className="text-4xl md:text-7xl font-bold pb-5">Jasa Kontruksi dan Pengadaan Barang</h1>
