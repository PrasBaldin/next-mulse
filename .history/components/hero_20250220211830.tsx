        ...
        <>
            <div className="hero-wrap">
                ...
                <div className="container">
                    <div className="w-full lg:w-[60vw] absolute top-[35vh] max-lg:left-0 max-lg:right-0 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-100 transition duration-300 ease-in-out">
                        <div className="p-5">
