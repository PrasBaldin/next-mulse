        ...
        <>
            <div className="hero-wrap">
                ...
                <div className="container">
                    ...
                    <div className=" bg-opacity-40 backdrop-blur-2xl p-3 w-full lg:w-[60vw] absolute top-[40vh] max-lg:left-0 max-lg:right-0 text-gray-700 dark:text-gray-100 transition duration-300 ease-in-out">
                        <div className="p-5">
