...
const Navbar = () => {
  ...
  return (
    <>
      ...
      {/* Overlay Sidebar */}
      <div
        className={`lg:hidden fixed top-20 left-0 w-full h-full bg-black/50 backdrop-blur-sm transition-opacity duration-500 ease-in-out z-[9] ${
      ...
      {/* Sidebar Menu */}
      <div
        className={`bg-white dark:bg-gray-800 lg:hidden fixed top-16 right-0 w-64 h-full shadow-lg transform transition-transform duration-500 ease-in-out z-10 ${
