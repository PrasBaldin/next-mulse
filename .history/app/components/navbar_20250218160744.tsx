                    ...
                    <div className="flex justify-between items-center py-3">
                        ...
                        <div className="hidden md:flex space-x-6 items-center">
                            ...
                            <div className="relative group" onMouseEnter={() => setIsDropdownOpen(true)} onMouseLeave={() => setIsDropdownOpen(false)} >
                                ...
                                <div className={`absolute left-0 mt-2 w-56 py-4 bg-white border border-gray-200 shadow-xl rounded-lg overflow-visible transition-all duration-300 ${isDropdownOpen ? "opacity-100 visible scale-100" : "opacity-0 invisible scale-95"}`} >
                                    <Link href="/pengadaan-barang" className="block px-4 py-1 text-gray-700 hover:bg-blue-200 transition" >
                                        Pengadaan Barang
                                    </Link>
                                    <Link href="/jasa-konstruksi" className="block px-4 py-1 text-gray-700 hover:bg-blue-200 transition" >
                                        Jasa Konstruksi
                                    </Link>
                                </div>
                            </div>
