                ...
                <div className="p-6 flex flex-col space-y-4">
                    ...
                    <div>
                        ...
                        >
                            Services
                            <span
                                className={`ml-2 w-3 h-3 border-b-2 border-r-2 border-gray-700 transition-all duration-300 ${isDropdownOpen ? "rotate-45 relative -top-1" : "-rotate-45 absolute right-0"
                                    }`}
                            ></span>
                        </button>
                        <div
