                        ...
                        <div className="hidden md:flex space-x-6 items-center">
                            ...
                            <div className="relative group" onMouseEnter={() => setIsDropdownOpen(true)} onMouseLeave={() => setIsDropdownOpen(false)} >
                                ...
                                <div className={`bg-white dark:bg-gray-800 absolute top-8 -left-2 w-56 pt-2 p-3 border-2 border-blue-500 shadow-xl rounded-lg overflow-visible transition-all duration-300 ${isDropdownOpen ? "opacity-100 visible scale-100" : "opacity-0 invisible scale-95"}`} >
                                    <Link href="/pengadaan-barang" className="nav-link rounded border-b border-gray-200 hover:border-blue-500 block px-2" >
                                        Pengadaan Barang
                                    </Link>
                                    <Link href="/jasa-konstruksi" className="nav-link rounded border-b border-gray-200 hover:border-blue-500 block px-2" >
                                        Jasa Konstruksi
                                    </Link>
                                </div>
                            </div>
