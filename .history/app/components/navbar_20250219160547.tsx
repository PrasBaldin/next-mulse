            ...
            < div className={`bg-white dark:bg-gray-800 lg:hidden fixed top-16 right-0 w-64 h-full shadow-lg transform transition-transform duration-300 ${isOpen ? "translate-x-0" : "translate-x-full"}`}  >
                <div className="p-6 flex flex-col space-y-4">
                    ...
                    <button onClick={() => setIsDarkMode(!isDarkMode)} className="btn flex items-center gap-2">
                        {isDarkMode ? (
                            <>
                                <div className={`btn-toggle-darkmode-mobile transform ${isDarkMode ? 'opacity-100 rotate-0' : 'opacity-0 rotate-90'}`} >
                                    <IconLightMode />
                                </div>
                            ...
                            <>
                                <div className={`btn-toggle-darkmode-mobile transform ${isDarkMode ? 'opacity-0 rotate-180' : 'opacity-100 rotate-0'}`} >
                                    <IconDarkMode />
                                </div>
