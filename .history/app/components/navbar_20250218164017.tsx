                    ...
                    <div className="flex justify-between items-center py-3">
                        ...
                        <div className="hidden md:flex space-x-6 items-center">
                            ...
                            <div className="relative group" onMouseEnter={() => setIsDropdownOpen(true)} onMouseLeave={() => setIsDropdownOpen(false)} >
                                ...
                                <div className={`absolute left-0 w-56 pt-2 p-3 bg-white border border-blue-200 shadow-xl rounded-lg overflow-visible transition-all duration-300 ${isDropdownOpen ? "opacity-100 visible scale-100" : "opacity-0 invisible scale-95"}`} >
