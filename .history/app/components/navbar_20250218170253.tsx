        ...
        <>
            ...
            <div className={`md:hidden fixed top-16 right-0 w-64 h-full bg-white shadow-lg transform transition-transform duration-300 ${isOpen ? "translate-x-0" : "translate-x-full"}`}  >
                <div className="p-6 flex flex-col space-y-4">
                    ...
                    <div>
                        <button
                            className="pb-2 border-b border-gray-200 flex items-center text-gray-700 hover:text-blue-500 hover:border-blue-500 transition w-full text-left"
                            onClick={() => setIsDropdownOpen(!isDropdownOpen)}
                        >
                            Services
                            <span
                                className={`ml-2 w-3 h-3 border-b-2 border-r-2 border-gray-700 hover:border-blue-500 transition-all duration-300 ${isDropdownOpen ? "rotate-45 relative -top-1" : "-rotate-45"
                                    }`}
                            ></span>
                        </button>
                        <div
