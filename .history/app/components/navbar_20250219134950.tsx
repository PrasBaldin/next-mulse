                ...
                <div className="container">
                    <div className="flex justify-between items-center py-3">
                        ...
                        <div className="hidden lg:flex space-x-6 items-center">
                            ...
                            <button onClick={() => setIsEnglish(!isEnglish)} className="btn ml-2 font-medium text-gray-700 dark:text-gray-300">
                                {isEnglish ? <IconEN /> : <IconID />}
                            </button>
                            <button onClick={() => setIsDarkMode(!isDarkMode)} className="btn ml-2" >
                                {isDarkMode ? (
