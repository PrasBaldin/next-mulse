        ...
        <>
            ...
            <nav className="bg-white shadow-md fixed w-full z-50">
                <div className="max-w-6xl mx-auto px-4">
                    <div className="flex justify-between items-center py-4">
                        ...
                        <div className="hidden md:flex space-x-6 items-center">
                            ...
                            >
                                <button className="flex items-center text-gray-700 hover:text-blue-500 transition">
                                    ...
                                    {/* Arrow */}
                                    <div
                                        className={`child-arrow ${isDropdownOpen ? "toggle-on" : ""
                                            }`}
                                    />
                                </button>
                        ...
                        >
                            <div
                                className={`absolute w-6 h-[3px] bg-gray-800 rounded transition-all duration-300 ${isOpen
            ...
            >
                <div className="p-6 flex flex-col space-y-4">
                    <Link
                        href="/"
                        className="pb-2 border-b border-gray-200 text-gray-700 hover:text-blue-500 transition"
                        onClick={() => setIsOpen(false)}
                    >
                        Home
                    </Link>
