                    ...
                    <div className="flex justify-between items-center py-3">
                        ...
                        <div className="hidden lg:flex space-x-6 items-center">
                            ...
                            <button onClick={() => setIsEnglish(!isEnglish)} className="btn font-medium text-gray-700 dark:text-gray-300">
                                <div className={`toggle-change-lang transform transition ${isEnglish ? 'opacity-100 rotate-0' : 'opacity-0 rotate-90'}`} >
                                    <IconEN />
                                </div>
                                <div className={`toggle-change-lang transform transition ${isEnglish ? 'opacity-0 -rotate-90' : 'opacity-100 rotate-0'}`} >
                                    <IconID />
                                </div>
                            </button>
