        ...
        <>
                    ...
                    <div className="flex justify-between items-center py-4">
                        ...
                        <div className="hidden md:flex space-x-6">
                            ...
                            <div className="relative">
                                ...
                                {/* Dropdown Menu */}
                                <div
                                    className={`absolute left-0 mt-2 w-48 bg-white shadow-lg rounded-lg transition-all duration-300 ${isDropdownOpen ? "opacity-100 visible scale-100" : "opacity-0 invisible scale-95"
                                        }`}
                                >
                                    <Link
            ...
            >
                <div className="p-6 flex flex-col space-y-4">
                    ...
                    {/* Menu Services dengan Dropdown di Sidebar */}
                    <div>
                        <button
                            className="text-gray-700 hover:text-blue-500 transition w-full text-left"
                            onClick={() => setIsDropdownOpen(!isDropdownOpen)}
                        >
                            Services
                        </button>
