                ...
                <div className="container">
                    <div className="flex justify-between items-center py-3">
                        ...
                        <div className="hidden lg:flex space-x-6 items-center">
                            ...
                            <button onClick={() => setIsEnglish(!isEnglish)} className="btn transition font-medium text-gray-700 dark:text-gray-300">
                                {isEnglish ? <IconEN /> : <IconID />}
                            </button>
                            <button onClick={() => setIsDarkMode(!isDarkMode)} className="btn transition w-11 h-11 relative overflow-hidden">
                                {/* Icon Light Mode */}
                                <div
                                    className={`absolute inset-0 flex items-center justify-center transition-all duration-300 transform ${isDarkMode ? 'opacity-100 rotate-0' : 'opacity-0 rotate-90'
                                        }`}
                                >
                                    <IconLightMode />
                                </div>
                                {/* Icon Dark Mode */}
                                <div
                                    className={`absolute inset-0 flex items-center justify-center transition-all duration-300 transform ${isDarkMode ? 'opacity-0 -rotate-90' : 'opacity-100 rotate-0'
                                        }`}
                                >
                                    <IconDarkMode />
                                </div>
