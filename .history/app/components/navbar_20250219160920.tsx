        ...
        <>
                    ...
                    <div className="flex justify-between items-center py-3">
                        ...
                        <div className="hidden lg:flex space-x-6 items-center">
                            ...
                            <button onClick={() => setIsDarkMode(!isDarkMode)} className="btn w-11 h-11 relative overflow-hidden">
                                <div className={`btn-toggle-darkmode ${isDarkMode ? 'opacity-100 rotate-0' : 'opacity-0 rotate-90'}`} >
                                    <IconLightMode />
                                </div>
                                <div className={`btn-toggle-darkmode ${isDarkMode ? 'opacity-0 -rotate-90' : 'opacity-100 rotate-0'}`} >
                                    <IconDarkMode />
                                </div>
                            </button>
                        </div>
            ...
            < div className={`bg-white dark:bg-gray-800 lg:hidden fixed top-16 right-0 w-64 h-full shadow-lg transform transition-transform duration-300 ${isOpen ? "translate-x-0" : "translate-x-full"}`}  >
                <div className="p-6 flex flex-col space-y-4">
                    ...
                    <button onClick={() => setIsEnglish(!isEnglish)} className="btn flex items-center gap-2" >
                    ...
                    <button onClick={() => setIsDarkMode(!isDarkMode)} className="btn flex items-center gap-2">
                        {isDarkMode ? (
                            <>
                                <div className={`flex items-center justify-center transition-all duration-300 transform ${isDarkMode ? 'opacity-100 rotate-0' : 'opacity-0 rotate-90'}`} >
                                    <IconLightMode />
                                </div>
                            ...
                            <>
                                <div className={`flex items-center justify-center transition-all duration-300 transform ${isDarkMode ? 'opacity-0 rotate-180' : 'opacity-100 rotate-0'}`} >
                                    <IconDarkMode />
                                </div>
