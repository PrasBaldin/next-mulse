            ...
            <nav className="navbar">
                <div className="container">
                    <div className="flex justify-between items-center py-3">
                        <Link href="/" className="text-2xl font-bold text-[#3bbced] dark:text-gray-100 flex items-center transition duration-500 ease-in-out ">
                        ...
                        <div className="hidden lg:flex space-x-6 items-center">
                            ...
                            <a href="https://katalog.mulse.id" target="_blank" className="nav-link">
                                {("navbar.catalog")}
                            </a>
