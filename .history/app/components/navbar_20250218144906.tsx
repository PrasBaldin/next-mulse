                        ...
                        <div className="hidden md:flex space-x-6 items-center">
                            ...
                            >
                                <button className="flex items-center text-gray-700 hover:text-blue-500 transition">
                                    ...
                                    >
                                        {/* Arrow icon created using two lines */}
                                        <div
                                            className={`w-2.5 h-2.5 border-t-2 border-r-2 border-gray-700 inline-block transform transition-transform duration-300 ${isDropdownOpen ? "rotate-45" : "rotate-0"
                                                }`}
                                        ></div>
                                        <div
                                            className={`w-2.5 h-2.5 border-t-2 border-l-2 border-gray-700 inline-block transform transition-transform duration-300 ${isDropdownOpen ? "-rotate-45" : "rotate-0"
                                                }`}
                                        ></div>
                                    </span>
                                </button>
