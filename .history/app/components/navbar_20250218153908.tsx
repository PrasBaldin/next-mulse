                    ...
                    <div className="flex justify-between items-center py-4">
                        ...
                        <div className="hidden md:flex space-x-6 items-center">
                            ...
                            <div className="relative group" onMouseEnter={() => setIsDropdownOpen(true)} onMouseLeave={() => setIsDropdownOpen(false)} >
                                ...
                                <div
                                    className={`absolute left-0 mt-2 w-56 bg-white border border-gray-200 shadow-xl rounded-lg overflow-hidden transition-all duration-300 ${isDropdownOpen
                                        ? "opacity-100 visible scale-100"
                                        : "opacity-0 invisible scale-95"
                                        }`}
                                >
                                    {/* "Tail" bubble */}
                                    <div className="absolute -top-2 left-6 w-4 h-4 bg-white border border-gray-200 transform -rotate-45"></div>
                                    <Link
                                        href="/pengadaan-barang"
                                        className="border-b boder-gray-200 block px-4 py-3 text-gray-700 hover:bg-blue-100 transition"
                                    >
                                        Pengadaan Barang
                                    </Link>
                                    <Link
