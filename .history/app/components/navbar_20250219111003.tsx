        ...
        <>
            ...
            < div className={`bg-white dark:bg-gray-800 md:hidden fixed top-16 right-0 w-64 h-full shadow-lg transform transition-transform duration-300 ${isOpen ? "translate-x-0" : "translate-x-full"}`}  >
                <div className="p-6 flex flex-col space-y-4">
                    ...
                    <div>
                        <button className="button text-gray-700 hover:text-blue-500 dark:text-gray-100 pb-2 border-b border-gray-200 transition flex items-center w-full" onClick={() => setIsDropdownOpen(!isDropdownOpen)} >
                            Services
                            <span
                                className={`span-border border-b-2 border-r-2 border-gray-700 dark:border-gray-100 ml-2 w-3 h-3 transition-all duration-300 ${isDropdownOpen ? "rotate-45 absolute right-7 mb-2" : "-rotate-45 absolute right-7"
                                    }`}
                            ></span>
                        </button>
