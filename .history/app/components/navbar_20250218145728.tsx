        ...
        <>
            ...
            >
                <div className="p-6 flex flex-col space-y-4">
                    ...
                    <div>
                        <button
                            className="flex items-center text-gray-700 hover:text-blue-500 transition w-full text-left"
                            onClick={() => setIsDropdownOpen(!isDropdownOpen)}
                        >
                            Services
                            <span
                                className={`ml-1 transition-transform duration-300 ${isDropdownOpen ? "rotate-180" : "rotate-45"
                                    }`}
                            >
                                {/* Icon panah berbentuk V dengan dua garis */}
                                <div
