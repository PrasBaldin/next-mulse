            ...
            <nav className="navbar">
                <div className="container">
                    <div className="flex justify-between items-center py-3">
                        <Link href="/" className="text-2xl font-bold text-[#3bbced] flex items-center">
                            <Image src={MulseSVG} alt="img" className="w-12 mr-4" />Mulse Citra Nusa
                        </Link>

                        {/* Menu untuk Desktop */}
                        <div className="hidden md:flex space-x-6 items-center">
                            <Link href="/" className="text-gray-700 hover:text-blue-500 dark:text-gray-100 py-1 transition border-b-2 border-transparent hover:border-blue-500">
                                Home
                            </Link>

                            {/* Menu Services dengan Dropdown (Hover di Desktop) */}
                            <div className="relative group" onMouseEnter={() => setIsDropdownOpen(true)} onMouseLeave={() => setIsDropdownOpen(false)} >
                                <button className="text-gray-700 group-hover:text-blue-500 dark:text-gray-100 flex items-center py-1 transition border-b-2 border-transparent">
                                    Services
                                </button>
                            ...
                            <Link href="https://katalog.mulse.id" target="blank" className="py-1 text-gray-700 hover:text-blue-500 transition border-b-2 border-transparent hover:border-blue-500">
                                Catalog
                            </Link>
                            <Link href="/gallery" className="py-1 text-gray-700 hover:text-blue-500 transition border-b-2 border-transparent hover:border-blue-500">
                                Gallery
                            </Link>
