                    ...
                    <div className="flex justify-between items-center py-3">
                        ...
                        <div className="hidden lg:flex space-x-6 items-center">
                            ...
                            <button onClick={() => setIsDarkMode(!isDarkMode)} className="btn relative overflow-hidden">
                                {/* Icon Light Mode */}
                                <div
                                    className={`absolute inset-0 flex items-center justify-center transition-all duration-300 transform p-3 ${isDarkMode ? 'opacity-100 rotate-0' : 'opacity-0 rotate-90'
                                        }`}
                                >
                                    <IconLightMode />
                                </div>
