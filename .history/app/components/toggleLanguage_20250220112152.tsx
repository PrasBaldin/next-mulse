    ...
    return (
        <>
            ...
            <button onClick={() => setIsEnglish(!isEnglish)} className="lg:hidden btn flex items-center gap-2" >
                ...
                <div className={`absolute index-0 ${isEnglish ? 'opacity-100 scale-1' : 'opacity-0 scale-0'}`} >
                    <IconEN />
                </div>
                <div className={`absolute index-0 ${isEnglish ? 'opacity-0 scale-0' : 'opacity-100 scale-1'}`} >
                    <IconID />
                </div>
