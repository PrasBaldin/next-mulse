  ...
  return (
    <>
      ...
      <section className="pt-20 pb-[8rem]">
        <div className="container">
          <div className="text-center text-3xl font-semibold text-gray-700 dark:text-gray-100 mb-8">
            <h3>
              OUR
              <br />
              PROJECTS
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4">
            {[
              ...
              <div
                key={index}
                className="bg-red-100 shadow-md max-h-[300px] overflow-hidden relative group mt-5"
              >
                <Image
                  src={item.img}
                  alt="img"
                  width={1000}
                  height={1000}
                  className="h-[450px] transform transition duration-500 group-hover:scale-[1.05]"
                ></Image>
