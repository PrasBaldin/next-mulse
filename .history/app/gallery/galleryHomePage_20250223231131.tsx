...
const GalleryHomePage = () => {
  return (
    <>
      <section>
        <div className="bg-sky-400 dark:bg-sky-700 py-20 flex justify-center text-center">
          <div className="w-full mb-20 ">
            <h3 className="text-3xl font-semibold text-gray-100 dark:text-gray-800 w-full mb-4">
              Recent Work
            </h3>
            <p className="w-full text-gray-100 dark:text-gray-800 text-lg">
