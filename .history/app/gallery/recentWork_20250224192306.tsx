...
const RecentWork = () => {
  return (
    <>
      <section>
        <div className="bg-gradient-to-bl from-gray-800 to-gray-700 dark:from-gray-900 dark:to-gray-800 py-20 flex justify-center text-center">
          <div className="w-full mb-20 ">
            <h4 className="mb-3 text-sky-500 font-semibold tracking-[.25em] uppercase">
              Recent Work
            </h4>
            <h3 className="w-full text-gray-100 dark:text-gray-100 text-3xl md:text-4xl font-bold">
