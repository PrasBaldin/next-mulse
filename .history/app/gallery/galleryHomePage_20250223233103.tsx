          ...
          <div className="grid grid-cols-2 gap-0 relative top-[-100px]">
            <div className="card bg-red-100 shadow-md max-h-[500px] overflow-hidden relative">
              ...
              <div className="overlay absolute inset-0">
                <div className="absolute inset-0 bg-gray-800 transition duration-500 opacity-0 hover:opacity-80 z-0" />
                <div className="z-[1] relative p-6 text-gray-100 opacity-100">
                  <h3>Pekerjaan 1</h3>
