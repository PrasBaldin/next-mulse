          ...
          <div className="grid grid-cols-2 gap-0 relative top-[-100px]">
            <div className="card bg-red-100 shadow-md max-h-[500px] overflow-hidden relative">
              <Image
                ...
                className="h-[450px]"
              ></Image>
              <div className="z-[1] overlay absolute top-0 bottom-0 left-0 right-0 bg-gray-800 transition duration-500 opacity-0 hover:opacity-60">
                <div className="z-[2] relative p-6 text-gray-100 opacity-100">
                  <h3>Pekerjaan 1</h3>
