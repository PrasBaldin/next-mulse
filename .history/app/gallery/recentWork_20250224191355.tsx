      ...
      <section>
        <div className="bg-gradient-to-bl from-sky-300 to-sky-400 dark:from-sky-700 dark:to-sky-800 py-20 flex justify-center text-center">
          <div className="w-full mb-20 ">
            <h2 className="text-3xl font-semibold text-sky-900 dark:text-gray-100 uppercase tracking-[.25em] w-full mb-4">
              Recent Work
            </h2>
            <p className="w-full text-sky-900 dark:text-gray-100 text-3xl md:text-4xl font-bold">
