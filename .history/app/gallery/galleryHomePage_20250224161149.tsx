            ...
            {[
              ...
              >
                ...
                <div className="overlay absolute inset-0 group">
                  ...
                  <div className="z-[1] relative p-10 text-gray-100 transition duration-500 opacity-0 group-hover:opacity-100 text-center h-full flex flex-col justify-center items-center border-2">
