      ...
      <section>
        <div className="bg-gradient-to-bl from-sky-300 to-sky-400 dark:from-sky-700 dark:to-sky-800 py-20 flex justify-center text-center">
          <div className="w-full mb-20 ">
            <h4 className="mb-3 text-sky-900 font-semibold tracking-[.25em] uppercase">
              Recent Work
            </h4>
            <h3 className="w-full text-gray-500 dark:text-gray-100 text-3xl md:text-4xl font-bold">
