      ...
      <section>
        ...
        <div className="container">
          <div className="grid grid-cols-2 gap-0 relative top-[-100px]">
            <div className="card bg-red-100 shadow-md px-4 p-[20rem] transform translate-y-[-50px]">
              <span>gambar 1</span>
            </div>
            <div className="card bg-red-200 shadow-md px-4 p-[20rem]">
              <span>gambar 2</span>
            </div>
            <div className="card bg-red-300 shadow-md px-4 p-[20rem] transform translate-y-[-50px]">
              <span>gambar 3</span>
            </div>
