        ...
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4">
            {[
              ...
              <div
                key={index}
                className="shadow-md max-h-[400px] xl:max-h-[300px] overflow-hidden relative group"
              >
                <Image
                  src={item.img}
                  alt="img"
                  width={1000}
                  height={1000}
                  className="h-[600px] md:h-[300px] xl:h-[200px] transform transition duration-500 group-hover:scale-[1.05]"
                ></Image>
