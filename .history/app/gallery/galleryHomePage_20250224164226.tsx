    ...
    <>
      <section>
        ...
        <div className="container">
          <div className="grid grid-cols-1 md:grid-cols-2 relative top-[-100px]">
            {[
              {
                ...
                <div className="overlay absolute inset-0">
                  <div className="p-5 text-gray-100 transition duration-500 opacity-0 group-hover:opacity-100 text-center h-full">
                    <div className="p-5 border-2 border-sky-500 h-full flex flex-col justify-center items-center relative">
                      <div className="absolute inset-0 bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-100 transition duration-500 opacity-0 group-hover:opacity-80 z-0" />
                      <div className="z-[2]">
