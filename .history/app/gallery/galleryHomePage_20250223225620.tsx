        ...
        <div className="bg-sky-500 dark:bg-sky-700 py-20 flex justify-center text-center">
          <div className="w-full mb-20 ">
            ...
            <p className="w-full text-gray-100">
              Berikut adalah beberapa proyek terbaru kami yang menampilkan
              inovasi dan kualitas kerja yang tinggi. Kami bangga dapat terus
              memberikan hasil yang memuaskan bagi klien kami.
            </p>
          </div>
        </div>
