        ...
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
            {[
              ...
              <div
                key={index}
                className="shadow-md max-h-[350px] md:max-h-[300px] lg:max-h-[300px] overflow-hidden relative group"
              >
                <Link href="/">
                  <Image
                    src={item.img}
                    ...
                    width={1000}
                    height={1000}
                    className="h-[350px] md:h-[300px] lg:h-[300px] xl:h-[200px] transform transition duration-500 group-hover:scale-[1.05]"
                  ></Image>
