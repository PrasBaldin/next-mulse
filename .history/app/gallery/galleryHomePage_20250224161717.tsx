            ...
            {[
              ...
              >
                ...
                <div className="overlay absolute inset-0 group">
                  <div className="z-[1] relative p-5 text-gray-100 transition duration-500 opacity-0 group-hover:opacity-100 text-center h-full">
                    <div className="z-[1] p-5 border-2 border-sky-500 h-full flex flex-col justify-center items-center relative">
