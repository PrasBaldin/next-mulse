            ...
            {[
              ...
              >
                ...
                <div className="overlay absolute inset-0 group">
                  ...
                  <div className="z-[1] relative p-10 text-gray-100 transition duration-500 opacity-0 group-hover:opacity-100 text-center h-full">
                    <div className="border-2 border-sky-500 h-full flex flex-col justify-center items-center">
