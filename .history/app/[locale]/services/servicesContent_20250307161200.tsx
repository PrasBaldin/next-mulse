    ...
    <>
      <section className="w-full flex flex-col lg:flex-row">
        ...
        >
          ...
          <div className="z-[2] relative sm:max-w-[630px] md:max-w-[758px] lg:max-w-[524.400px] xl:max-w-[678px] 2xl:max-w-[831.600px] m-auto lg:mr-0 px-4 lg:pr-10">
            <div className="py-20">
        ...
        <div className="w-full lg:w-2/5 bg-white dark:bg-gradient-to-bl dark:from-gray-900 dark:to-gray-800 text-gray-700 dark:text-gray-100">
          <div className="sm:max-w-[630px] md:max-w-[758px] lg:max-w-[489.600px] xl:max-w-[392px] 2xl:max-w-[494.400px] m-auto lg:ml-0 px-4 lg:pl-10">
            <div className="py-20">
              <AnimationFadeIn
                delay={0.15}
                duration={1}
