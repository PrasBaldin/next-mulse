        ...
        <div className="pt-1 lg:pt-4 pb-20 bg-gradient-to-b from-white to-gray-200 dark:from-gray-900 dark:to-gray-800 z-[2]">
          <div className="container mx-auto px-4">
            ...
            <div className="flex flex-col md:flex-row justify-between items-stretch gap-8">
              ...
              {/* Card Misi */}
              <div className="flex-1 bg-gray-100 dark:bg-gradient-to-br dark:form-gray-800 dark:to-gray-600 p-8 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 border-l-4 border-sky-400 z-[2]">
                <h3 className="text-2xl font-semibold text-gray-700 dark:text-gray-100 mb-4">
                  Misi
                </h3>
