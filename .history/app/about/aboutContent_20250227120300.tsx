      ...
      <div className="container relative z-[2] pb-[3rem]">
        <div className="flex flex-col lg:flex-row items-center">
          ...
          <div className="w-full lg:w-1/2 p-4 text-gray-700 dark:text-gray-100 transition duration-500 ease-in-out">
            <h4 className="mb-3 text-sky-500 font-semibold tracking-[.25em] uppercase animated animated-duration-100">
              Who We Are
            </h4>
            <h3 className="text-3xl lg:text-4xl font-bold mb-4 lg:pr-8 animated animated-duration-150">
              Solusi Konstruksi &amp; Pengadaan Barang
            </h3>
            <p className="mb-4 animated animated-duration-200">
            ...
            <p className="mb-4 animated animated-duration-250">
            ...
            <p className="mb-4 animated animated-duration-300">
