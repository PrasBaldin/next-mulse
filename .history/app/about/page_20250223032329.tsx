        ...
        <>
            ...
            <section className="py-16 bg-gradient-to-r from-blue-50 to-purple-50 dark:from-gray-900 dark:to-gray-800">
                <div className="container mx-auto px-4">
                    <h2 className="text-4xl font-bold text-center text-gray-800 dark:text-gray-100 mb-12 relative inline-block">
                        Visi &amp; Misi Kami
                        {/* <span className="absolute -bottom-2 left-1/2 transform -translate-x-1/2 w-24 h-1 bg-blue-500"></span> */}
                        <div className="w-12 md:w-[100%] h-1 rounded mb-4 bg-gradient-to-r from-sky-400 to-transparant" />
                    </h2>
                    <div className="flex flex-col md:flex-row justify-between items-stretch gap-8">
                        {/* Card Visi */}
                        <div className="flex-1 bg-white dark:bg-gray-700 p-8 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 border-l-4 border-blue-500">
