const AboutPage = () => {
    return (
        <>
            <section className="mt-0 pt-0 md:pt-[16rem] lg:pt-[15rem] xl:pt-[13rem] pb-[5rem]" style={{ backgroundImage: "url('/img/about-bg-1.webp')" }}>
                <div className="container">
                    <div className="flex flex-col md:flex-row items-center">
                        {/* Kolom gambar */}
                        <div className="w-full md:w-1/2 p-4 max-h-[500px] overflow-hidden">
                            <img
