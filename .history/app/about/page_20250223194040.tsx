  ...
  return (
    <>
      <section className="relative">
        ...
        {/* Visi Misi */}
        <div className="pt-2 lg:pt-4 pb-20 bg-gradient-to-b from-white to-gray-200 dark:from-gray-900 dark:to-gray-800 z-[2]">
          <div className="container mx-auto px-4">
            <h2 className="w-full text-4xl font-bold text-center text-gray-700 dark:text-gray-100 mb-12 relative inline-block">
              ...
              <div className="relative">
                <div className="w-[200px] absolute left-1/2 transform -translate-x-1/2 h-1 rounded mb-4 bg-gradient-to-r from-transparent via-sky-400 to-transparent" />
              </div>
            </h2>
