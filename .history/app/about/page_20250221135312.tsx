const AboutPage = () => {
    return (
        <>
            <section className="" style={{ backgroundImage: "url('/img/about-bg-1.webp')" }}>
                <div className="relative pt-0 md:pt-[16rem] lg:pt-[15rem] xl:pt-[13rem] pb-[6rem]">
                    <div className="about-mask absolute inset-0 flex items-center justify-center bg-white bg-opacity-30 dark:bg-opacity-50 text-white text-3xl font-bold transition duration-500 ease-in-out z-[0]" />
