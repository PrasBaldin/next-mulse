        ...
        <div className="container mx-auto px-4">
          ...
          <div className="flex flex-col md:flex-row justify-between items-stretch gap-8">
            ...
            <AnimationFadeIn
              ...
              triggerOnExit
            >
              <div className="h-full bg-white dark:bg-gradient-to-br dark:form-gray-700 dark:to-gray-600 p-8 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 border-l-4 border-sky-400 z-[2]">
