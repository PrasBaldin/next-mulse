const AboutPage = () => {
    return (
        <>
            ...
            <section className="py-16 bg-gradient-to-b from-white to-gray-200 dark:from-gray-900 dark:to-gray-800">
                <div className="w-full h-2 md:w-[50%] bg-gradient-to-lr from-sky-400 to-transparant" />
