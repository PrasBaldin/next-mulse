    ...
    <>
      ...
      <div className="container relative z-[2] pb-[3rem]">
        <div className="flex flex-col lg:flex-row items-center">
          <div className="w-full lg:w-1/2 m-4 max-h-[400px] overflow-hidden animation-fade">
            <Image
              width={900}
              height={900}
          ...
          {/* Kolom deskripsi */}
          <div className="w-full lg:w-1/2 p-4 text-gray-700 dark:text-gray-100 transition duration-500 ease-in-out animation-slide-up">
