...
const ContactContent: React.FC = () => {
  ...
  return (
    <section className="bg-white dark:bg-gray-700 text-gray-700 dark:text-white py-16">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full p-3 rounded bg-gray-200 border border-gray-300 focus:outline-none focus:ring-2 focus:ring-sky-500"
                  required
                />
              </div>
              ...
              <button type="submit" className="px-6 py-3 btn btn-primary">
                Submit
              </button>
            </form>
          </div>
          ...
          <div className="p-8">
            ...
            <ul className="space-y-6">
              <li>
                ...
                <p className="dark:text-gray-100 text-gray-700 transition duration-500 ease-in-out">
              ...
              <li>
                ...
                <a
                  ...
                  target="_blank"
                  className="dark:text-gray-100 text-gray-700 hover:text-sky-500 dark:hover:text-sky-500 transition duration-500 ease-in-out"
                >
                  info@mulse.id
                </a>
              </li>
