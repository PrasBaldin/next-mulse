  ...
  return (
    <section className="bg-black text-white py-16 px-4">
      ...
      <div className="max-w-4xl mx-auto text-center mb-12">
        <h4 className="mb-3 text-sky-500 font-semibold tracking-[0.25em]">
          CONTACT US
        </h4>
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
        {/* Bagian Kiri: Form */}
        <div className="p-8 bg-[#111111] rounded">
        ...
        <div className="p-8">
          ...
          <ul className="space-y-6">
            ...
            <li>
              <h4 className="text-sm uppercase font-bold mb-1">Email Us At</h4>
              <p className="text-green-400 hover:text-green-300 transition-colors cursor-pointer">
                contacts@glintsite.com
              </p>
            </li>
            <li>
              <h4 className="text-sm uppercase font-bold mb-1">Call Us</h4>
              <p className="text-gray-300">Phone: (+63) 555 1212</p>
              <p className="text-gray-300">Mobile: (+63) 555 0100</p>
              <p className="text-gray-300">Fax: (+63) 555 0101</p>
            </li>
          </ul>
        </div>
      </div>
