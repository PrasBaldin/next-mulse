...
const ContactContent: React.FC = () => {
  ...
  return (
    <section className="bg-gradient-to-bl from-gray-200 to-gray-100 dark:from-gray-800 dark:to-gray-700 text-gray-800 dark:text-white py-16">
      <div className="container">
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
          {/* Bagian Kiri: Form */}
          <div className="p-8 bg-gray-300 dark:bg-gray-600 rounded">
