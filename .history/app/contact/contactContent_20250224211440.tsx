...
const ContactContent: React.FC = () => {
  ...
  // State untuk menampilkan pesan sukses atau error submit
  ...
  const handleChange = (
    ...
    // Jika field yang diubah adalah email, jalankan validasi
    if (name === "email") {
      ...
      // Untuk field lain, jika ingin validasi, bisa ditambahkan juga
      setErrors((prev) => ({
        ...prev,
        [name]: "", // reset error jika ada
      }));
    }
  };
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    // Validasi akhir sebelum submit (jika diperlukan)
    ...
    if (emailError) {
      ...
      return; // hentikan submit jika email invalid
    }
