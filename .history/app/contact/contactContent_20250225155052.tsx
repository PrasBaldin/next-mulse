            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full p-3 rounded bg-gray-300 dark:bg-gray-500 border border-gray-400 dark:border-gray-600 focus:outline-none focus:ring-2 focus:ring-sky-500 transition duration-500 ease-in-out"
                  required
                />
              </div>
                ...
                <input
                  ...
                  className={`${
                    errors.email
                      ...
                      : "border-gray-400 focus:ring-sky-500 "
