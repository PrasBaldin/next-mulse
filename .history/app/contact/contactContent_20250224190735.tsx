          ...
          <div className="p-8">
            ...
            <ul className="space-y-6">
              ...
              <li>
                ...
                <p className="text-gray-100 hover:text-sky-500 transition-colors cursor-pointer">
                  info@mulse.id
                </p>
              </li>
              <li>
                <h4 className="text-sm uppercase font-bold mb-1">Call Us</h4>
                <p className="text-gray-100">Phone: (+62) 21 2204 9859</p>
                <p className="text-gray-100">Mobile: (+62) 852 6006 2002</p>
              </li>
            </ul>
          </div>
        </div>
