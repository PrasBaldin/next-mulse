            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                <input
                  ...
                  } w-full p-3 rounded bg-gray-200 dark:bg-gray-600 border dark:border-gray-700 focus:outline-none focus:ring-2 focus:ring-sky-500 transition duration-500 ease-in-out`}
                  required
                />
                <span>${errors.email ? "Email not valid" : ""}</span>
              </div>
