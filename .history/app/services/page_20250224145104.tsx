  ...
  return (
    <>
      <section className="w-full flex flex-col lg:flex-row">
        ...
        >
          <div className="z-[1] absolute inset-0 bg-sky-100 bg-opacity-50 dark:bg-gray-900 dark:bg-opacity-90 transition duration-500 ease-in-out" />
                ...
                {[
                  ...
                  <div key={index} className="proc-card">
                    ...
                    <div className="proc-card-overlay">
                      <div className="mx-10 py-10 xl:py-5 relative">
