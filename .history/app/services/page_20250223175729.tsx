            ...
            <div className="w-4/5">
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                {[
                  ...
                  { title: "Alat Kesehatan", img: "/img/proc-office.jpg" },
                  { title: "Alat Kebersihan", img: "/img/proc-office.jpg" },
                  { title: "Alat Elektronik", img: "/img/proc-office.jpg" },
                  { title: "Seragam dan Pakaian", img: "/img/proc-office.jpg" },
                  { title: "Souvenir" },
                ].map((item, index) => (
                  <div
                    key={index}
