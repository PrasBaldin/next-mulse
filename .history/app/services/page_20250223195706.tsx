          ...
          <div className="w-full flex flex-col lg:flex-row gap-6">
            <div className="w-full lg:w-1/4 space-y-4">
              ...
              <a
                ...
                target="_blank"
              >
                <button className="btn my-4 text-sky-500 hover:text-white border-2 border-sky-500 hover:bg-sky-500">
                  Lihat Selengkapnya
                </button>
              </a>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                {[
                  ...
                  <div key={index} className="proc-card">
                    ...
                    />
                    <div className="proc-card-overlay relative">
                      <div className="z-[1] bg-gray-100 dark:bg-gray-700 mx-10 py-5 relative">
                        <div className="absolute inset-0 bg-gray-100 dark:bg-gray-700 opacity-40"></div>
                        <div className="relative z-[1]">
                          ...
                          <a
                            ...
                            target="_blank"
                          >
                            <button className="mt-4 inline-block bg-sky-500 hover:bg-sky-600 text-white px-4 py-2 rounded-lg transition duration-300">
                              Lihat Selengkapnya
                            </button>
                          </a>
                        </div>
