  ...
  return (
    <>
      <section className="w-full flex flex-col lg:flex-row">
        ...
        <div className="w-full lg:w-2/5 bg-gray-700 dark:bg-gray-800 text-gray-100">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                {[
                  ...
                  <div key={index} className="proc-card group">
                    ...
                    />
                    <div className="proc-card-overlay p-5 h-full">
                      <div className="p-5 border-2 border-sky-500 h-full rounded relative">
                        <div className="absolute inset-0 bg-gray-100 dark:bg-gray-700 rounded opacity-80" />
