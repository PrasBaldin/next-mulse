    ...
    <>
      <section className="w-full flex flex-col lg:flex-row">
        <div className="w-full lg:w-3/5 bg-sky-200">
          <div className="sm:max-w-[640px] md:max-w-[768px] lg:max-w-[614.400px] xl:max-w-[768px] 2xl:max-w-[921.600px] m-auto pl-8 pr-8">
            <div className="py-20">
        ...
        <div className="w-full lg:w-2/5 bg-gray-800 text-gray-100">
          <div className="sm:max-w-[640px] md:max-w-[768px] lg:max-w-[409.600px] xl:max-w-[512px] 2xl:max-w-[614.400px] m-auto pr-8 pl-8">
            <div className="py-20">
