          ...
          <div className="w-full flex flex-row gap-4">
            ...
            <div className="w-4/5">
              <div className="grid grid-cols-3">
                <div className="">
                  <span>icon svg</span>
                  <span>Alat Perlengkapan Kantor</span>
                  <a href="/" target="_blank">Lihat Selengkapnya</a>
                </div>
                <div className="">
                  <span>icon svg</span>
                  <span>Alat Kesehatan<
                    <a href="/" target="_blank">Lihat Selengkapnya</a>/span>
                </div>
                <div className="">
                  <span>icon svg</span>
                  <span>Alat Kebersihan
                    <a href="/" target="_blank">Lihat Selengkapnya</a>
                  </span>
                </div>
                <div className="">
                  <span>icon svg</span>
                  <span>Alat Elektronik
                    <a href="/" target="_blank">Lihat Selengkapnya</a>
                  </span>
                </div>
                <div className="">
                  <span>icon svg</span>
                  <span>Seragam dan Pak
                    <a href="/" target="_blank">Lihat Selengkapnya</a>aian</span>
                </div>
                <div className="">
                  <span>icon svg</span>
                  <span>Souvenir</span>
