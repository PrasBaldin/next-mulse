          ...
          <div className="sm:max-w-[640px] md:max-w-[768px] lg:max-w-[399.600px] xl:max-w-[502px] 2xl:max-w-[604.400px] m-auto lg:ml-0 px-4 lg:pl-10">
            <div className="py-20">
              ...
              <AnimationFadeIn
                ...
                triggerOnExit
              >
                <h3 className="mb-4 text-4xl font-bold">Jasa Konstruksi</h3>
              </AnimationFadeIn>
              <AnimationFadeIn
                delay={0.25}
                duration={1}
              ...
              >
                <p className="py-2 my-2">
                  ...
                  yang interior dan eksterior. Setiap layanan kami dirancang
                  untuk memenuhi standar kualitas tertinggi dan disesuaikan
              ...
              >
                <p className="py-2 my-2">
                  ...
                  electrical engineering terkini. Dengan pendekatan
                  terintegrasi, kami memastikan efisiensi, keamanan, dan
                  keandalan dalam setiap tahap pengerjaan.
                </p>
              </AnimationFadeIn>
              <AnimationFadeIn
                delay={0.35}
            ...
            <div className="w-full lg:w-1/4 space-y-4">
              ...
              >
                <p className="pr-5 text-lg text-gray-600 dark:text-gray-300">
                  ...
                  operasional bisnis dan organisasi Anda, mulai dari alat
                  kantor, perlengkapan medis, hingga elektronik dan souvenir.
                </p>
              </AnimationFadeIn>
              <AnimationFadeIn
                delay={0.3}
