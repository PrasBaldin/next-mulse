    ...
    <>
      <section className="w-full flex flex-col lg:flex-row">
        <div className="w-full lg:w-[60%] bg-sky-200">
          <div className="sm:max-w-[640px] md:max-w-[768px] lg:max-w-[614.4px] xl:max-w-[768px] 2xl:max-w-[921.6px] m-auto px-4 lg:pr-10">
            <div className="py-20">
        ...
        <div className="w-full lg:w-[40%] bg-gray-800 text-gray-100">
          <div className="sm:max-w-[640px] md:max-w-[768px] lg:max-w-[409.6px] xl:max-w-[512px] 2xl:max-w-[614.4px] m-auto px-4 lg:pl-10">
            <div className="py-20">
