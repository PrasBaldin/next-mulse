              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 border-t-4 border-blue-500 hover:shadow-2xl transition duration-300">
                  ...
                  >
                    <g>
                      <path
                        d="M360.102,240.012l10.156-10.266c0,0,15.609-13.406,33.406-7.328c30.984,10.578,66.781-0.875,91.609-25.734 c7.063-7.063,15.641-21.234,15.641-21.234c0.984-1.344,1.328-3.047,0.922-4.672l-1.922-7.906c-0.359-1.484-1.313-2.75-2.625-3.531
                                                c-1.313-0.766-2.891-0.969-4.344-0.547l-60.984,16.969c-2.266,0.625-4.688-0.219-6.063-2.109l-28.015-38.594
                                                c-0.859-1.172-1.219-2.641-1.016-4.063l5.641-41c0.297-2.234,1.891-4.047,4.063-4.656l64.406-17.922 c2.906-0.813,4.672-3.813,3.953-6.766l-2.547-10.359c-0.344-1.469-1.281-2.719-2.563-3.5c0,0-5.047-3.344-8.719-5.234
                      ...
                      />
                      <path
                        d="M211.383,295.418C143.024,361.652,68.461,433.715,68.461,433.715c-2.547,2.438-4,5.797-4.047,9.313
                      ...
                      />
                      <path
                        d="M501.43,451.371c2.484-2.484,3.859-5.859,3.813-9.375c-0.031-3.516-1.5-6.859-4.031-9.297L227.415,166.246
                                                l-43.953,43.969L450.805,483.09c2.438,2.547,5.781,4,9.297,4.047s6.891-1.344,9.391-3.828L501.43,451.371z"
                      />
                      <path
                        d="M254.196,32.621c-32.969-12.859-86.281-14.719-117.156,16.141c-24.313,24.313-59.875,59.891-59.875,59.891
                ...
                <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 border-t-4 border-blue-500 hover:shadow-2xl transition duration-300">
                  <div className="mb-4 flex justify-center">
                    <img
                      src="/img/service4.svg"
                      alt="Renovasi &amp; Perbaikan"
                      className="w-12 h-12"
                    />
                  </div>
                  <h3 className="text-xl font-semibold text-gray-800 dark:text-white mb-2 text-center">
                ...
                <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 border-t-4 border-blue-500 hover:shadow-2xl transition duration-300">
                  <div className="mb-4 flex justify-center">
                    <img
                      src="/img/service2.svg"
                      alt="Pengadaan Material"
                      className="w-12 h-12"
                    />
                  </div>
                  <h3 className="text-xl font-semibold text-gray-800 dark:text-white mb-2 text-center">
          ...
          <div className="sm:max-w-[640px] md:max-w-[768px] lg:max-w-[512px] xl:max-w-[640px] 2xl:max-w-[768px] ml-auto mr-auto lg:ml-0 px-4 lg:pl-10">
            <div className="py-20">
              ...
              <p className="mb-2">
                ...
                commodi magnam soluta illum laboriosam exercitationem modi
                aperiam dolorum eligendi nemo!
              </p>
              <p className="mb-2">
                Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quas
                at laudantium ipsum culpa, voluptatum sapiente hic tempora cum
                quaerat? Odit id ullam sint cumque rerum a sed quae nulla
                incidunt sapiente esse at, minima corporis earum animi adipisci
                repellat temporibus excepturi sunt! Voluptatibus tempore fuga
                aut ipsa recusandae omnis consectetur?
              </p>
              <p>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Magnam
                tempore adipisci numquam obcaecati. Repellat nesciunt dolorum
                tenetur, dolor unde veritatis aliquam reiciendis quas, et veniam
                eius id placeat sequi? Maxime voluptate velit officia ducimus
                totam.
              </p>
            </div>
          </div>
