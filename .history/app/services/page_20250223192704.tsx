        ...
        <div className="container">
          <div className="w-full flex flex-row gap-4">
            <div className="w-1/5">
              ...
              <p className="mt-4 pr-5 text-lg text-gray-600 dark:text-gray-300">
                Kami menyediakan berbagai kebutuhan barang untuk mendukung
                operasional bisnis dan organisasi Anda, mulai dari alat kantor,
                perlengkapan medis, hingga elektronik dan souvenir. Temukan
                produk berkualitas dengan layanan terbaik dari kami.
              </p>
            </div>
            <div className="w-4/5">
