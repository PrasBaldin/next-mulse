    ...
    <>
      ...
      <section className="py-20">
        <div className="container text-center">
          ...
          <h3 className="py-2 my-2 mx-auto w-3/4 text-gray-700 dark:text-gray-100 transition duration-500 ease-in-out text-xl font-semibold">
            Kami menghadirkan solusi konstruksi yang menyeluruh dan inovatif
            untuk memenuhi standar kualitas tertinggi
          </h3>
        </div>
      </section>
    </>
