      ...
      <section className="py-20">
        <div className="container text-center">
          ...
          <p className="py-2 my-2">
            ...
            mulai dari pembangunan bangunan baru hingga renovasi yang interior
            dan eksterior. Setiap layanan kami dirancang untuk memenuhi standar
            kualitas tertinggi dan disesuaikan dengan kebutuhan spesifik klien.
          </p>
        </div>
      </section>
    </>
