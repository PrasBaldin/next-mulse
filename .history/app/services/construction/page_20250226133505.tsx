      ...
      <section className="py-20">
        <div className="container">
          <div className="mb-10 text-center">
            ...
            <h3 className="py-2 my-2 mx-auto w-full md:w-3/4 text-gray-700 dark:text-gray-100 transition duration-500 ease-in-out text-xl font-semibold">
          ...
          <div className="service-content grid grid-cols-2 md:grid-cols-3">
            <div className="card bg-gray-200 rounded p-8">
              ...
              <div className="card-title text-xl font-semibold py-3">
                <h4>Judul Jasa</h4>
              </div>
