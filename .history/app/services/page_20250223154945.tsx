  ...
  return (
    <>
      <section className="w-full flex flex-col lg:flex-row">
        <div className="w-full lg:w-3/4 bg-sky-200">
          <div className="sm:max-w-[640px] md:max-w-[768px] lg:max-w-[771px] xl:max-w-[640px] 2xl:max-w-[768px] ml-auto mr-auto lg:mr-0 px-4 lg:pr-10">
            <div className="py-20">
        ...
        <div className="w-full lg:w-1/4 bg-gray-800 text-gray-100">
          <div className="sm:max-w-[640px] md:max-w-[768px] lg:max-w-[257px] xl:max-w-[640px] 2xl:max-w-[768px] ml-auto mr-auto lg:ml-0 px-4 lg:pl-10">
            <div className="py-20">
