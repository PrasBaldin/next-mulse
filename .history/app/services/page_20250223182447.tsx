            ...
            <div className="w-4/5">
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                {[
                  ...
                  <div
                    key={index}
                    className="bg-white rounded-lg shadow-md flex items-center text-center transition-transform transform duration-300 ease-in-out hover:shadow-lg overflow-hidden"
                  >
                    <Image
                      src={item.img}
                      width={900}
