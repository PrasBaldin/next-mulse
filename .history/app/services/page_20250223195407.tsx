                  ...
                  <div key={index} className="proc-card">
                    ...
                    <div className="proc-card-overlay relative">
                      <div className="z-[1] bg-gray-100 dark:bg-gray-700 mx-10 py-5 opacity-90">
                        <h4 className="z-[2] font-semibold text-lg mt-3">
                          {item.title}
                        </h4>
                        <a
                          href="https://katalog.inaproc.id/mulse-citra-nusa"
                          target="_blank"
                        >
                          <button className="z-[2] mt-4 inline-block bg-sky-500 hover:bg-sky-600 text-white px-4 py-2 rounded-lg transition duration-300"></button>
                          Lihat Selengkapnya
                        </a>
                      </div>
                    </div>
