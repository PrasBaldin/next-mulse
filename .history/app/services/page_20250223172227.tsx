          ...
          <div className="w-full flex flex-row gap-4">
            ...
            <div className="w-4/5">
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                {[
                  { title: "Alat Perlengkapan Kantor", icon: "🖊️" },
                  { title: "Alat Kesehatan", icon: "🏥" },
                  { title: "Alat Kebersihan", icon: "🧹" },
                  { title: "Alat Elektronik", icon: "💻" },
                  { title: "Seragam dan Pakaian", icon: "👔" },
                  { title: "Souvenir", icon: "🎁" },
                ].map((item, index) => (
                  <div
                    key={index}
                    className="bg-white rounded-lg shadow-md p-6 flex flex-col items-center text-center transition-transform transform duration-500 ease-in-out hover:scale-105 hover:shadow-lg"
                  >
