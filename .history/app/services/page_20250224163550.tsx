                ...
                {[
                  ...
                  <div key={index} className="proc-card group">
                    <Image
                      ...
                      height={1000}
                      alt="img"
                      className="bg-cover z-[1] transform transition duration-500 group-hover:scale-[1.05]"
                    />
                    <div className="proc-card-overlay p-10 h-full relative">
                      <div className="p-5 border-2 border-sky-500 relative">
