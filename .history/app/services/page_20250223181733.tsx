            ...
            <div className="w-4/5">
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                {[
                  ...
                  <div
                    key={index}
                    className="bg-white rounded-lg shadow-md flex items-center text-center transition-transform transform duration-300 ease-in-out hover:scale-105 hover:shadow-lg overflow-hidden"
                  >
                    <Image
                      src={item.img}
                      width={900}
                    ...
                    />
                    <div className="absolute left-0 right-0 z-[2]">
                      <div className="bg-gray-100 mx-10 py-10 backdrop-blur-sm">
