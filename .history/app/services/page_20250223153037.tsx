            ...
            <div className="py-20">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    >
                      <g transform="translate(1 1)">
                        <g>
                          <g>
                            <path
                              d="M511.017,204.688c0-2.56-0.853-4.267-2.56-5.973l-60.587-60.587c-1.509-1.509-3.021-2.348-5.12-2.523V67.768
				...
				l18.319-18.374l48.64,48.64L203.817,490.555z"
                            />
                            <path
                              d="M33.151-0.965c-18.773,0-34.133,15.36-34.133,34.133v17.067v34.133v324.267v25.6c0,0.853,0,1.707,0.853,3.413
