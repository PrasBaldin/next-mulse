    ...
    <>
      <section className="w-full flex flex-col lg:flex-row">
        <div className="w-full lg:w-3/5 bg-sky-200">
          <div className="sm:max-w-[640px] md:max-w-[768px] lg:max-w-[664.400px] xl:max-w-[818px] 2xl:max-w-[971.600px] m-auto mr-0 px-4 lg:pr-10">
            <div className="py-20">
        ...
        <div className="w-full lg:w-2/5 bg-gray-800 text-gray-100">
          <div className="sm:max-w-[640px] md:max-w-[768px] lg:max-w-[359.600px] xl:max-w-[462px] 2xl:max-w-[544.400px] m-auto ml-0 px-4 lg:pl-10">
            <div className="py-20">
