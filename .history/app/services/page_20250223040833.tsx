const ServicesPage = () => {
    return (
        <>
            <section className="py-16 bg-gradient-to-b from-sky-200 to-sky-500 dark:bg-gray-900">
                <div className="container relative z-[2] pt-0 md:pt-[16rem] lg:pt-[15rem] xl:pt-[13rem] pb-[3rem]">
                    <div className="flex flex-col lg:flex-row items-center">
                        <div className="w-full lg:w-1/2 p-4 bg-sky-700 text-gray-700 dark:text-gray-100 transition duration-500 ease-in-out">
                        </div>
