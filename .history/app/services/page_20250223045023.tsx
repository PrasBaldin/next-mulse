        ...
        <>
            <section className="w-full flex flex-col lg:flex-row">
                <div className="w-full lg:w-1/2 bg-sky-200">
                    <div className="sm:max-w-[640px] md:max-w-[768px] lg:max-w-[512px] xl:max-w-[640px] 2xl:max-w-[768px] ml-auto mr-auto lg:mr-0 px-4 lg:pr-[10rem]">
                        <div className="py-5">
                            <p>content</p>
                        </div>
                    </div>
                ...
                <div className="w-full lg:w-1/2 bg-gray-800 text-gray-100">
                    <div className="sm:max-w-[640px] md:max-w-[768px] lg:max-w-[512px] xl:max-w-[640px] 2xl:max-w-[768px] ml-auto mr-auto lg:ml-0 px-4 lg:pl-[10rem]">
                        <div className="py-5">
